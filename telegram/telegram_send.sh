...
# INPUT $1
curl -s -X POST https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/sendMessage -d chat_id=${TELEGRAM_BOT_CHATID} -d text="${1}" >> ~/logs/telegram.log
